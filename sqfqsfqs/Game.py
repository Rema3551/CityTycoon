...
class Game:
    ...
    def createBuildings(self, tmx_data):
        ...
        """
        self.buildings = [self.poubelle1, self.poubelle2, self.poubelle3, self.poubelle4, self.poubelle5, self.poubelle6, self.poubelle7, self.poubelle8, self.poubelle9, self.poubelle10, self.rouge, self.help, self.orange]#self.hdv, self.maisonette, self.maison] #
