...
class Affichage:
    ...
    def __init__(self, game: Game):
        ...
        self.tmx_data2 = pytmx.util_pygame.load_pygame('assets/map/ville2.tmx')
        ...
        if game.getGameStep() == GameStep.IDLE :
            for building in game.buildings: 
                ...
                if(player.feet.colliderect(building.getCollideArea())):
                    ...
                    textPrice = pygame.font.SysFont('comicsansms', 50).render(str(building.strPrice()), True, self.colorWood)
